      ...
      <MDBFooter className="footer-color text-center text-lg-start text-white" id="contact">
        <section className="footer-position">
          <MDBContainer className="text-center text-md-start">
            <MDBRow className="">
              <MDBCol sm="8" md="8" lg="5" xl="4" className="mx-auto mb-4">
                <h6 className="logo-footer text-uppercase mt-5 mb-4">Pet Food</h6>
                <p>
                  If you have any question, please contact us at
                  <br />
                  <span>coderunner153@gmail.com</span>
                </p>
                <p>
                  <MDBIcon icon="home" className="me-3" />
                  C/24 PANNIYAPITIYA ,COLOMBO 10
                </p>
                <p>
                  <MDBIcon icon="phone" className="me-3" /> 076-5090871
                </p>
              </MDBCol>
          ...
          <div className="payment d-flex justify-content-between align-items-center flex-wrap pe-5 me-5 ps-5 ms-5 pb-4">
            ...
            <img
              src="https://thumbs.dreamstime.com/b/lviv-ukraine-march-mastercard-visa-logo-credit-money-card-plastic-debit-icon-vector-illustration-editorial-273430308.jpg"
              alt="Payment Methods"
            />
          </div>
        </section>
